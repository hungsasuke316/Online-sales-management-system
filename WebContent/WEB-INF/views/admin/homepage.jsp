...
<base href="${pageContext.servletContext.contextPath }/"> 
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="<c:url value='/resources/srcAdHomepage/assets/favicon.ico'/>" />
        <!-- Core theme CSS (includes Bootstrap)-->
        <link href="<c:url value='/resources/srcAdHomepage/css/styles.css'/>" rel="stylesheet" />
    </head>
    <body>
        <!-- Responsive navbar-->
       <!--  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <!-- Core theme JS-->
        <script src="<c:url value='/resources/srcAdHomepage/js/scripts.js'/>"></script>
    </body>
</html>
